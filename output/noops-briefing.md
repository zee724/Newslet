...
## 1. NOOPS Weekly — Week of 18 May 2026

- Published: Thu, 21 May 2026 22:45:49 GMT
- Link: https://noops.au/posts/noops-weekly-week-of-18-may-2026

The week the AI build-out became a capital-markets story — OpenAI and SpaceX toward IPO, Nvidia's record print — and then, in its final act, revealed the tension beneath it: the access layer is raising public money at unprecedented scale while the supply layer has started to refuse to build.

## 2. [Signal] Nvidia beats, guides higher and announces an $80bn buyback
...
## 3. [Signal] OpenAI moves toward an IPO as the public-capital channel opens
...
## 4. [Signal] SpaceX's S-1 books the enterprise-software layer as a $22.7tn market
...
## 5. [Signal] OpenAI sells guaranteed compute capacity for cash upfront
...
## 6. [Signal] A practitioner case that structural backpressure beats smarter agents
...
## 7. [Signal] AI produces original research: an Erdős conjecture and drug retargeting
...
## 8. [Signal] Qwen 3.7-Max ships as a proprietary, agent-native model
